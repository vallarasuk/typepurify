...
- Added `generateChangelogFromCommits()` scaffolding helper.
...
- Added `formatError` and `formatSuccess` terminal text formatters.
...
- Enhanced cli package with advanced utilities and additional test cases
